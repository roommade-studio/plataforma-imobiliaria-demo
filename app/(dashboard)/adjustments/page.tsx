    ...
    <>
      <div className={styles.page}>
        ...
        <div className={styles.stats}>
          <StatCard label="Reajustes no Mês"   value={5}      trend={0} trendLabel="vs. mês anterior" icon={<IconTrendUp />} />
          <StatCard label="Valorização Média" value="+3,2%"                                               icon={<IconPercent />} />
          <StatCard label="Imóveis Reajustados" value="5/18"                                              icon={<IconCheck />} />
        </div>
